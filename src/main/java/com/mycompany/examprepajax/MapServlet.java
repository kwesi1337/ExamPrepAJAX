 ...
 */
package com.mycompany.examprepajax;
...
public class MapServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        receivePostRequest(request, response);
    }
    ...
    private void receivePostRequest(HttpServletRequest request, HttpServletResponse response){
